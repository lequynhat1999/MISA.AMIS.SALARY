<template>
  <div class="dropdown col-2 dropdown-filter" @click="toggleDropdown" :style="{width: widthDropdown + 'px'}">
    ...
    <div
      ...
      :style="{width: widthDropdownData + 'px',top: topDropdownData + 'px',right: rightDropdownData + 'px'}"
...
export default {
  name: "BaseDropdown",
  props: ["url", "fields", "data", "hiddenIcon", "value","widthDropdown","widthDropdownData","topDropdownData","rightDropdownData"],
  components: {
  },
  async created() {
    await this.getItem();
